...
$sql11 = "SELECT end FROM periods WHERE idperiods = $AID_Period;";
...
$sql8 = "SELECT
  ...
  LEFT JOIN accounting_accounts c on (a.id_account = c.idaccounting_accounts)
...
if($result8 = mysqli_query($con,$sql8)){
    while($row8 = mysqli_fetch_assoc($result8)){
        ...
        $exportRow[1] = $row8['external_id'];
        $exportRow[2] = $row8['name'];
        $exportRow[3] = $row8['amount'];
