...
if($result = mysqli_query($con, $sql))
{
	...
	if($result = mysqli_query($con, $sql2)){
		...
		$mail->IsHTML(true);
		$mail->AddAddress('accounting@nearsol.gt', 'Accounting');
		$mail->AddAddress('timekeeping@nearsol.gt', 'TimeKeeping');
		$mail->AddAddress('itsupport@nearsol.gt', 'IT');
		$mail->AddAddress('it.staff@nearsol.gt', 'IT Staff');
		$mail->AddAddress('facilities@nearsol.gt', 'Facilities');
