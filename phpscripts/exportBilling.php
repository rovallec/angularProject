...
ROUND(IF(employees.job_type = 1, 0, employees.base_payment),2) AS `base`,
ROUND(IF(employees.job_type = 1, 0, employees.productivity_payment),2) AS `productivity`,
...
INNER JOIN (
            ...
            INNER JOIN employees ON employees.idemployees = payments.id_employee
            WHERE debits.type = 'Descuento IGSS' AND id_period IN($period)
