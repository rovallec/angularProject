<?php
    ...
    if($result = mysqli_query($con, $sql)){
        while($row = mysqli_fetch_assoc($result)){
            ...
            if (strtoupper($row['marital_status'])=='SINGLE') {
              if ($gender == 'Femenino') {
                  $gender = $gender . ", " . 'Soltera';
                } else if ($gender == 'Masculino') {
                  $gender = $gender . ", " . 'Soltero';
                } else { // default
                  $gender = $gender . ", ";
                }
            } else if (strtoupper($row['marital_status'])=='MARRIED') {
               if ($gender == 'Femenino') {
                  $gender = $gender . ", " . 'Casada';
                } else if ($gender == 'Masculino') {
                  $gender = $gender . ", " . 'Cadado';
                } else { // default
                  $gender = $gender . ", ";
                }
            }

            switch (strtoupper($row['marital_status'])) {
              case 'SINGLE':
                if ($gender == 'Femenino') {
                  $gender = $gender . ", " . 'Soltera';
                } else if ($gender == 'Masculino') {
              ...
              case 'DIVORCEE':    
                if ($gender == 'Femenino') {
                  $gender = $gender . ", " . 'Divorciada';
                } else if ($gender == 'Masculino') {
                  $gender = $gender . ", " . 'Divorciado';
                }
              break;
            }
            ...
            if ($row['profesion']!='') {
              $gender = $gender . ", " . $row['profesion'] . ", ";
            } else {
              $gender = $gender . ", " ;
            }

            if ($row['nationality']!='') {
              $gender = $gender . ", " . $row['nationality'] . ", ";
            } else {
              $gender = $gender . ", " ;
            }
            ...
            $incentivo_n_cent_l = $f->format(number_format($incentivo_n_init[1], 2));
                ...
                <div style='margin-left:20px; width:800px'>
                    <table>
                        ...
                        <tr>
                            ...
                            inherente al puesto. <b>A)</b> A ejecutar el trabajo personal con la intensidad, cuidado y esmero apropiados a NEARSOL, SOCIEDAD ANONIMA, bajo su dirección, dependencia y subordinación, así como a cumplir las</p></td>
                            </td>
                        </tr>
                        <tr>
