<?php
    ...
    if($result = mysqli_query($con, $sql)){
        while($row = mysqli_fetch_assoc($result)){
            ...
            $base_n_init = explode(".", number_format($base_n_n,2));
            ...
            $total_n_init = explode(".", $total_n_n);
            $total_n_int_l = $f->format($total_n_init[0]);
            $total_n_cent_l = $f->format(explode(".",number_format($total_n_n,2))[1]);

            if($total_n_cent_l == 'cero'){
                $total_n_cent_l = 'exactos';
            }else{
                $total_n_cent_l = ' con ' . $total_n_cent_l . ' centavos ';
            }
            ...
            <div style='margin-left:20px; width:800px'>
                <table>
                    ...
                    <tr>
                        ...
                        puesto. <b>A)</b> A ejecutar el trabajo personal con la intensidad, cuidado y esmero apropiados a  NEARSOL,  SOCIEDAD ANONIMA,  
                        bajo su dirección, dependencia y subordinación, así como a cumplir las órdenes e instrucciones que reciba en todo lo concerniente 
                        al trabajo que, <b style='color:white'>a</b> precisamente, <b style='color:white'>a</b>  consistirá  en  <b>B)</b> Marcar tarjeta, 
                        reloj biométrico o a firmar las listas de asistencia órdenes e instrucciones que reciba en todo lo concerniente al trabajo que, precisamente, 
                        consistirá en <b>B)</b> Marcar tarjeta relojen <b>B)</b>biométrico respectivas a la entrada y salida de sus labores. El incumplimiento de este requisito 
                        se computará como falta injustificada para todos los efectos legales a que haya lugar. <b>C)</b> A someterse a los exámenes y reconocimientos médicos que 
                        en forma periódica determine la empresa sean necesarios, el negarse a ello, será causa suficiente para ser separado de su trabajo sin responsabilidad para el Patrón.
                         <b>D)</b> Mantener una relación de exclusividad en la cual, el Trabajador prestará sus servicios en forma exclusiva al Patrono y no podrá prestar sus servicios de 
                         forma simultánea en otras empresas similares o que realicen actividades comerciales parecidas a esta empresa, salvo que éste autorice  lo  contrario  por  escrito.  
                          <u><b>La  violación  de  este  pacto  será  considerada  falta grave del Trabajador y será causa de despido justificado;</b></u> <b>E)</b> A
                          sujetarse y recibir los cursos de Capacitación y Adiestramiento que el patrono le proporcione,  en  su  caso; y,  <b>F)</b> Mantener la confidencialidad por virtud de la cual el Trabajador se obliga a guardar
                          </p>
                        </td>
                    </tr>
                    <tr>
