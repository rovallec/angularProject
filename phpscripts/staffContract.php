<?php
    ...
    if($result = mysqli_query($con, $sql)){
        while($row = mysqli_fetch_assoc($result)){
            ...
            $ot = explode(".", $others);
            $other_letters = $f->format($ot[0]) . " quetzales con " . $f->($ot[1]) . " centavos";
