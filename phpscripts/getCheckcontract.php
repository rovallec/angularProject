<?php
    ...
    if($result = mysqli_query($con, $sql)){
        ...
        $res['name'] = strtoupper($name);
        $res['birthday'] = strtoupper($birthday);
        $res['year'] = strtoupper($year);
        $res['today'] = strtoupper($today);
        $res['now'] = strtoupper($now);
        $res['age'] = strtoupper($age);
        $res['platform'] = strtoupper($platform);
        $res['gender'] = strtoupper($gender);
        $res['address'] = strtoupper($address);
        $res['municipio'] = strtoupper($municipio);
        $res['dpi_n'] = strtoupper($dpi_n);
        $res['hiring_date'] = strtoupper($hiring_date);
        $res['job'] = strtoupper($job);
        $res['base_n_n'] = strtoupper($base_n_n);
        $res['incentivo_n_n'] = strtoupper($incentivo_n_n);
        $res['total_n_n'] = strtoupper($total_n_n);
        $res['base_n'] = strtoupper($base_n);
        $res['incentivo_exp'] = strtoupper($incentivo_exp);
        $res['incentivo_n'] = strtoupper($incentivo_n);
        $res['total_n'] = strtoupper($total_n);
        $res['dpi_1'] = strtoupper($dpi_1);
        $res['dpi_2'] = strtoupper($dpi_2);
        $res['dpi_3'] = strtoupper($dpi_3);
        $res['dpi_4'] = strtoupper($dpi_4);
        $res['t'] = strtoupper($t);
        $res['base_n_init'] = strtoupper($base_n_init);
        $res['base_n_int_l'] = strtoupper($base_n_int_l);
        $res['base_n_cent_l'] = strtoupper($base_n_cent_l);
        $res['incentivo_n_init'] = strtoupper($incentivo_n_init);
        $res['incentivo_n_int_l'] = strtoupper($incentivo_n_int_l);
        $res['incentivo_n_cent_l'] = strtoupper($incentivo_n_cent_l);
        $res['total_n_init'] = strtoupper($total_n_init);
        $res['total_n_int_l'] = strtoupper($total_n_int_l);
        $res['total_n_cent_l'] = strtoupper($total_n_cent_l);
        $res['dt'] = strtoupper($dt);
        $res['date_letters'] = strtoupper($date_letters);
        $res['today_date'] = strtoupper($today_date);
        $res['dt_end'] = strtoupper($dt_end);
        $res['day'] = strtoupper($day);
        $res['mn'] = strtoupper($mn);
        $res['yr'] = strtoupper($yr);
