...
WHERE ((hr_processes.date BETWEEN '$start' AND '$end')
      ...
      AND (hr_processes.id_department != 28 AND hr_processes.id_type = 4 AND vacations.action != 'Paid' AND hr_processes.status IN ($state)) AND employees.id_account IN ($accounts)
