          ...
          if (proc.name === "Termination") {
            ...
            this.apiService.getTerm(proc).subscribe((term: terminations) => {
              ...
              this.apiService.getPayments(per).subscribe((pay: payments[]) => {
                ...
                end_date_plus_one = String(String(new Date(end_date).getFullYear()) + "-" + String(new Date(end_date).getMonth() + 1) + "-" + Number(new Date(end_date).getDate()).toString());
                ...
                cred_aguinaldo.amount = (((Number(base_salary(this.termination, this.employee))) / 365) * (((new Date(end_date_plus_one).getTime() - (new Date(a_date).getTime()))) / (1000 * 3600 * 24))).toFixed(2);
                ...
                cred_bono14.amount = (((Number(base_salary(this.termination, this.employee))) / 365) * ((new Date(end_date_plus_one).getTime() - new Date(b_date).getTime()) / (1000 * 3600 * 24))).toFixed(2);
                ...
                this.apiService.getVacations({ id: this.employee.id_profile }).subscribe((vacs: vacations[]) => {
                  ...
                  cred_vacations.amount = (((Number(base_salary(this.termination, this.employee))) / 30) * ((((new Date(end_date_plus_one).getTime() - new Date(this.employee.hiring_date).getTime()) / (1000 * 3600 * 24))) / (1 / (15 / 365)) - v_amount)).toFixed(2);
