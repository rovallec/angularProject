...
getSalaryReport(filter: any) {
  return this.httpClient.post<salaryReport[]>(`${this.PHP_API_SERVER}/phpscripts/getSalaryReport.php`, filter);
}

exportSalaryReport(filter: any) {
  return this.httpClient.post<any>(`${this.PHP_API_SERVER}/phpscripts/exportSalaryReport.php`, filter);
}
...
getPeriodsByEmployee(id: any){
  return this.httpClient.post<periods[]>(`${this.PHP_API_SERVER}/phpscripts/getPeriodsByEmployee.php`, id);
}
...
getCheckBooks() {
  return this.httpClient.get<checkbooks[]>(`${this.PHP_API_SERVER}/phpscripts/getCheckBooks.php`);
}
...
getEmployeeByWave(wave:waves_template){
...
getRosters(str:string){
  return this.httpClient.post<rosters[]>(`${this.PHP_API_SERVER}/phpscripts/getRosters.php`, str);
}
