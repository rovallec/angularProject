...
export class AccdashboardComponent implements OnInit {
  ...
  formerEmployer: formerEmployer = new formerEmployer;
  ...
  insertFormerEmployer() {
    this.apiService.insertFormerEmployer(formerEmployer).subscribe((_str: string) => { 
    //
    })
  }

  getFormerEmployer() {
    this.apiService.getFormerEmployer().subscribe((fe: formerEmployer[]) => { 
      //
      })
  }

  updateFormerEmployer() {
    this.apiService.updateFormerEmployer(formerEmployer).subscribe((_str: string) => { 
      //
      })
  }
